...
function VencordSettings() {
    ...
    return (
        <SettingsTab title="Vermcord Settings">
            {isDonor(user?.id) ? (
                <SpecialCard
                    title="Donations"
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Vermcord you now have a cool new badge!"
...
export default wrapTab(VencordSettings, "Vermcord Settings");
